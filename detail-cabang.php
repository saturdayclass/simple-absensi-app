...
$id = $_GET['id'];
$query = $conn->prepare("SELECT * FROM tb_cabang WHERE id_cabang = '$id'");
$query->execute();
				...
				<section class="section">
					<div class="section-header">
						...
						<div class="section-header-breadcrumb">
							...
							<div class="breadcrumb-item">Update Cabang</div>
						</div>
					</div>
											...
											<div class="row">
												<div class="col-md-12">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="nama" id="nama" required="" autocomplete="off" value="<?= $row['nama_cabang'] ?>" maxlength="100" autofocus="">
													</div>
												</div>
											</div>
											<div class="row">
