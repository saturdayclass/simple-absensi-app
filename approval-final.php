											...
											<div class="row">
												<div class="col-md-6">
													...
													<div class="form-group">
														<label for="approval_final">Approve</label>
														<input type="file" class="form-control" value="<?= $row['approval_final'] ?>" name="approval_final" id="approval_final" accept="image/png">
													</div>
												</div>
											</div>
											<div class="row">
