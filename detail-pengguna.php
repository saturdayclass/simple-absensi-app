...
$id = $_GET['id'];
$query = $conn->prepare("SELECT * FROM tb_user WHERE id_user = '$id'");
$query->execute();
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="nama" id="nama" required="" autocomplete="off" value="<?= $row['nama'] ?>" maxlength="100" autofocus="">
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group">
														<label for="nip">Nip</label>
														<input type="text" class="form-control" name="nip" id="nip" required="" autocomplete="off" value="<?= $row['nip'] ?>" maxlength="100" autofocus="">
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group">
												...
												<div class="col-md-4">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="username" id="username" required="" autocomplete="off" value="<?= $row['username'] ?>" minlength="5" maxlength="20" autofocus="">
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group">
														<label for="password">Kata Sandi</label>
														<input type="text" class="form-control" name="password" id="password" required="" autocomplete="off" value="<?= $row['password'] ?>" minlength="5" maxlength="20" autofocus="">
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group">
														...
														<select class="form-control select2" name="level" id="level" required="">
															...
															<option value="Pimpinan Unit">Pimpinan Cabang</option>
